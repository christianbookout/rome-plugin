...
public class MessageConstants { //TODO transfer all message strings to this file
    ...
    public static final String ELECTIONS_HELP_COMMAND = "/elections vote <user>" + ChatColor.BLACK + " | " + ChatColor.ITALIC + ChatColor.GRAY + "vote for a user. you may only vote for each position once.\n" + ChatColor.RESET +
                                                        "/elections run <title>" + ChatColor.BLACK + " | " + ChatColor.ITALIC + ChatColor.GRAY + "run for a position (permissions: "+ Title.QUAESTOR.color + Title.QUAESTOR.fancyName + ChatColor.ITALIC + ChatColor.GRAY +"+)\n" + ChatColor.RESET +
                                                        ...
                                                        "/elections start" + ChatColor.BLACK + " | " + ChatColor.ITALIC + ChatColor.GRAY + "start an election (permissions: "+ Title.CONSUL.color + Title.CONSUL.fancyName + ChatColor.ITALIC + ChatColor.GRAY + "/"+ Title.CENSOR.color + Title.CENSOR.fancyName + ChatColor.ITALIC + ChatColor.GRAY + ")\n" + ChatColor.RESET +
                                                        "/elections voting" + ChatColor.BLACK + " | " + ChatColor.ITALIC + ChatColor.GRAY + "start the voting phase (permissions: "+ Title.CONSUL.color + Title.CONSUL.fancyName + ChatColor.ITALIC + ChatColor.GRAY + "/"+ Title.CENSOR.color +Title.CENSOR.fancyName + ChatColor.ITALIC + ChatColor.GRAY + ")\n" + ChatColor.RESET +
                                                        "/elections end" + ChatColor.BLACK + " | " + ChatColor.ITALIC + ChatColor.GRAY + "end the current election, granting the winners their roles (permissions: "+ Title.CONSUL.color + Title.CONSUL.fancyName + ChatColor.ITALIC + ChatColor.GRAY + "/"+ Title.CENSOR.color +Title.CENSOR.fancyName + ChatColor.ITALIC + ChatColor.GRAY + ")\n" + ChatColor.RESET +
                                                        "/elections cancel" + ChatColor.BLACK + " | " + ChatColor.ITALIC + ChatColor.GRAY + "cancel the current election (permissions: "+ Title.CONSUL.color + Title.CONSUL.fancyName + ChatColor.ITALIC + ChatColor.GRAY + "/"+ Title.CENSOR.color +Title.CENSOR.fancyName + ChatColor.ITALIC + ChatColor.GRAY + ")\n";
